...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Entities.SubjectTeamSettings", b =>
                {
                    b.Property<Guid>("SubjectId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("FixedTeamSize")
                        .HasColumnType("integer");

                    b.Property<int?>("FixedTeamsCount")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("RequiredDecisionVotes")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("subject_team_settings", (string)null);
                });
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Entities.SubmissionDecisionSession", b =>
                {
                    ...
                    b.Property<int>("RequiredDecisionsCount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Entities.TeamGrade", b =>
                {
                    ...
                    b.Property<bool>("RedistributeTotalScore")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("TeamId", "AssignmentId")
                        .IsUnique();

                    b.ToTable("team_grades", (string)null);
                });

            modelBuilder.Entity("Infrastructure.Persistence.Entities.TeamMember", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Entities.TeamGrade", b =>
                {
                    b.HasOne("Infrastructure.Persistence.Entities.Submission", "Submission")
                        .WithOne("TeamGrade")
                        .HasForeignKey("Infrastructure.Persistence.Entities.TeamGrade", "SubmissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
